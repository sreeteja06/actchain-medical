...
function install_chaincode_meditrack(){
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@manuf1.meditrack.com/msp" peer0.manuf1.meditrack.com peer chaincode install -l node -n meditrackcc -p /etc/hyperledger/chaincode/meditrack -v v0
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@distr1.meditrack.com/msp" peer0.distr1.meditrack.com peer chaincode install -l node -n meditrackcc -p /etc/hyperledger/chaincode/meditrack -v v0
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@pharmacy1.meditrack.com/msp" peer0.pharmacy1.meditrack.com peer chaincode install -l node -n meditrackcc -p /etc/hyperledger/chaincode/meditrack -v v0
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@logistic1.meditrack.com/msp" peer0.logistic1.meditrack.com peer chaincode install -l node -n meditrackcc -p /etc/hyperledger/chaincode/meditrack -v v0
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@ia1.meditrack.com/msp" peer0.ia1.meditrack.com peer chaincode install -l node -n meditrackcc -p /etc/hyperledger/chaincode/meditrack -v v0
}
function instantiate_chaincode_meditrack(){
    ...
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@manuf1.meditrack.com/msp" peer0.manuf1.meditrack.com peer chaincode instantiate -l node -o orderer.meditrack.com:7050 -C meditrack -n meditrackcc -v v0 -c '{"Args":["init"]}' --collections-config privateDataCollectionMeditrack.json
}
...
function install_chain_agritrack(){
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@manuf1.meditrack.com/msp" peer0.manuf1.meditrack.com peer chaincode install -l node -n agritrackcc -p /etc/hyperledger/chaincode/agritrack -v v1
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@distr2.meditrack.com/msp" peer0.distr2.meditrack.com peer chaincode install -l node -n agritrackcc -p /etc/hyperledger/chaincode/agritrack -v v1
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@manuf2.meditrack.com/msp" peer0.manuf2.meditrack.com peer chaincode install -l node -n agritrackcc -p /etc/hyperledger/chaincode/agritrack -v v1
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@ia2.meditrack.com/msp" peer0.ia2.meditrack.com peer chaincode install -l node -n agritrackcc -p /etc/hyperledger/chaincode/agritrack -v v1
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@logistic2.meditrack.com/msp" peer0.logistic2.meditrack.com peer chaincode install -l node -n agritrackcc -p /etc/hyperledger/chaincode/agritrack -v v1
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@pharmacy2.meditrack.com/msp" peer0.pharmacy2.meditrack.com peer chaincode install -l node -n agritrackcc -p /etc/hyperledger/chaincode/agritrack -v v1
}
...
function instantiate_chaincode_agritrack(){
    ...
    docker exec -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@manuf1.meditrack.com/msp" peer0.manuf1.meditrack.com peer chaincode instantiate -l node -o orderer.meditrack.com:7050 -C agritrack -n agritrackcc -v v1 -c '{"Args":["init"]}' --collections-config privateDataCollectionAgritrack.json
}
